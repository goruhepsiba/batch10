import { g as getPublicEnvVariables } from "./env-Bu12Jr7a.mjs";
import { j as getEnvVariable, U as apiUrlFromPublishableKey } from "../_libs/clerk__shared.mjs";
import { b as createClerkClient } from "../_libs/clerk__backend.mjs";
const commonEnvs = () => {
...
const clerkClient = (options) => {
  ...
  return createClerkClient({
    ...
    userAgent: `@clerk/tanstack-react-start@1.4.5`,
