...
import { a as Route$a, u as useAuth, b as useServerFn, c as createSsrRpc } from "./router-BAKaFseM.mjs";
...
import { f as Sparkles, h as MapPin, k as Calendar, W as Wallet, g as LoaderCircle, B as BookmarkCheck, l as BookmarkPlus, S as Sun, m as Layers, n as ChartColumn, o as Sunrise, M as Moon, p as UtensilsCrossed, C as Compass, q as ChevronRight } from "../_libs/lucide-react.mjs";
...
function ItineraryView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl glass-card p-6 shadow-soft relative overflow-hidden group", children: [
      ...
      (itinerary.summary.includes("carefully designed") || itinerary.destination.includes("Heritage Tour")) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-4 rounded-xl bg-amber/5 border border-amber/20 text-xs text-amber/90 leading-relaxed font-light", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-amber", children: "Offline Fallback Mode Active:" }),
        " No active AI API key was found in your server's environment. Add an ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "OPENROUTER_API_KEY" }),
        " to your ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: ".env" }),
        " file and restart the project to enable live AI itinerary generation."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap gap-2.5 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Pill, { icon: Wallet, children: [
          "₹",
          itinerary.estimatedCostINR.low.toLocaleString("en-IN"),
          "–₹",
          itinerary.estimatedCostINR.high.toLocaleString("en-IN"),
          " est. cost"
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl glass-card p-6 border-l-4 border-l-amber/70 shadow-soft hover:shadow-elegant transition-all duration-500 space-y-4 hover:-translate-y-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between gap-4 border-b border-border/40 pb-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-muted-foreground bg-accent/40 px-2 py-1 rounded-md", children: [
              "~₹",
              d.estimatedCostINR.toLocaleString("en-IN"),
              " cost"
            ] })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl glass-card p-4 space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-bold text-foreground font-display", children: [
              "₹",
              Math.round(itinerary.days.reduce((sum, d) => sum + d.estimatedCostINR, 0) / itinerary.days.length).toLocaleString("en-IN")
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl glass-card p-4 space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-bold text-foreground font-display", children: [
              "Day",
              " ",
              itinerary.days.reduce((maxDay, d) => d.estimatedCostINR > maxDay.cost ? {
                day: d.day,
                cost: d.estimatedCostINR
              } : maxDay, {
                day: 1,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/60 bg-card p-5 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[250px] w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartContainer, { config: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { tickLine: false, axisLine: false, tickFormatter: (v) => `₹${v.toLocaleString("en-IN")}` }),
