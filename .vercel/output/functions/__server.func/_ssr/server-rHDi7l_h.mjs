...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cj17WxHm.mjs");
...
const manifest = {
  "0f1e3d259c849aa9c3b2c96d82f72a15cc19299cc9d34b757be612173a94929d": {
    functionName: "syncUserSession_createServerFn_handler",
    importer: () => import("./auth.fns-Co340nVx.mjs")
  },
  "38c2bd6a11e738a606415250a53c1985f161a3fea2d2dc6fad575c9298e90e87": {
    functionName: "describePlace_createServerFn_handler",
    importer: () => import("./place.functions-PcFa0XMt.mjs")
  },
  "45c0bfa6d4d83ec62f4f705bbe35b1b56d0e9491031256d2c8e19622c7540154": {
    functionName: "generateItinerary_createServerFn_handler",
    importer: () => import("./planner.functions-0ZbkOVdU.mjs")
  },
  "4a5ff6e762391fb989394c45483cf3d40a09f619ac3c6fcb9934367c6daf50de": {
    functionName: "getUsersList_createServerFn_handler",
    importer: () => import("./admin-CkGKUkWm.mjs")
  },
  "66b1e590f0d4997d9ed4cba88317acc65295332ad765eb3f607fa1cfdd52ba75": {
    functionName: "checkAuth_createServerFn_handler",
    importer: () => import("./auth.fns-Co340nVx.mjs")
  },
  "d3bfb29af9397275fb28e3d92ee57346e58f10677fecede46abec9f537989187": {
    functionName: "askAssistant_createServerFn_handler",
    importer: () => import("./chat.functions-BMwbOqA6.mjs")
  },
  "db31292ad4d7527a1941d9e2009dbc0ac4c2179cfacbb31f7928077a2a1fb269": {
    functionName: "updateUserRole_createServerFn_handler",
    importer: () => import("./admin-CkGKUkWm.mjs")
  },
  "f6fc415e29ec4934761fd226c3386cda58c24ac14d4aaa02d6701f1ae65f2ada": {
    functionName: "checkAdmin_createServerFn_handler",
    importer: () => import("./auth.fns-Co340nVx.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BAKaFseM.mjs").then((n) => n.r),
    import("./start-bDtUhU_k.mjs"),
