...
import { I as InternalClerkProvider, U as UserButton, u as useAuth$1, s as setErrorThrowerOptions } from "../_libs/clerk__react.mjs";
import { v as validateEnv } from "./env-CeXi8rGa.mjs";
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-rHDi7l_h.mjs";
import { T as Toaster$1, t as toast } from "../_libs/sonner.mjs";
import { i as isClient, g as getPublicEnvVariables } from "./env-Bu12Jr7a.mjs";
...
import { C as Compass, L as LayoutDashboard, H as Heart, U as User, S as Sun, M as Moon, a as LogOut, X, b as Menu, c as CircleQuestionMark, d as Send, e as MessageSquare } from "../_libs/lucide-react.mjs";
...
const ClerkOptionsProvider = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ClerkOptionsCtx.Provider, {
    value: { value: options },
    children
  });
};
...
function ClerkProvider({ children, ...providerProps }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [/* @__PURE__ */ jsxRuntimeExports.jsx(ScriptOnce, { children: `window.__clerk_init_state = ${JSON.stringify(clerkInitialState)};` }), /* @__PURE__ */ jsxRuntimeExports.jsx(ClerkOptionsProvider, {
    options: mergedProps,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(InternalClerkProvider, {
...
const checkAuth = createServerFn({
  method: "GET"
}).handler(createSsrRpc("66b1e590f0d4997d9ed4cba88317acc65295332ad765eb3f607fa1cfdd52ba75"));
const checkAdmin = createServerFn({
  method: "GET"
}).handler(createSsrRpc("f6fc415e29ec4934761fd226c3386cda58c24ac14d4aaa02d6701f1ae65f2ada"));
const syncUserSession = createServerFn({
  method: "POST"
}).handler(createSsrRpc("0f1e3d259c849aa9c3b2c96d82f72a15cc19299cc9d34b757be612173a94929d"));
const appCss = "/assets/styles-D4633Bpi.css";
function useAuth() {
  const { isLoaded, userId, signOut } = useAuth$1();
  const { user } = useUser();
  const mockUser = reactExports.useMemo(() => {
    if (!user) return null;
    return {
      id: user.id,
      ...
      role: user.publicMetadata?.role ?? "tourist",
      user_metadata: {
        display_name: user.fullName || user.username || user.primaryEmailAddress?.emailAddress?.split("@")[0] || "Traveler"
      }
    };
  }, [user]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border/60 backdrop-blur supports-[backdrop-filter]:bg-background/70", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-4 sm:px-6 flex h-16 items-center justify-between gap-2 sm:gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        ...
        loading ? null : user ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserButton, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden border-t border-border/60 bg-background/95 backdrop-blur px-4 py-4 space-y-1", children: [
      ...
      user ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border/40 flex items-center justify-between px-3", children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border/40 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/sign-in/$",
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ClerkProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AuthSyncer, {}),
...
const $$splitComponentImporter$c = () => import("./search-05C1gATb.mjs");
...
const $$splitComponentImporter$b = () => import("./profile-ClnMtyxO.mjs");
const Route$b = createFileRoute("/profile")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "View your user profile and authorization roles."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./planner-DDDSWl4H.mjs");
...
const Route$a = createFileRoute("/planner")({
...
const $$splitComponentImporter$9 = () => import("./favorites-_YDEjXzM.mjs");
const Route$9 = createFileRoute("/favorites")({
  beforeLoad: async () => {
    await checkAuth();
  },
  head: () => ({
...
const $$splitComponentImporter$8 = () => import("./dashboard-DZuxWhXv.mjs");
const Route$8 = createFileRoute("/dashboard")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your travel statistics, itineraries, and collections."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./bookings-d234XBca.mjs");
const Route$7 = createFileRoute("/bookings")({
  beforeLoad: async () => {
    await checkAuth();
  },
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your booked flights, hotels, and tours to historical destinations."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./auth-BTU5dmpx.mjs");
...
const $$splitComponentImporter$5 = () => import("./admin-BGF0LQE2.mjs");
const Route$5 = createFileRoute("/admin")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Management console for HeritageVerse administrators."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./index-Ofp_BbqI.mjs");
...
const $$splitComponentImporter$3 = () => import("./sign-up._-DnKaJP_N.mjs");
const Route$3 = createFileRoute("/sign-up/$")({
  head: () => ({
    meta: [{
      title: "Sign Up · HeritageVerse"
    }, {
      name: "description",
      content: "Create an account to save historical sites and generate AI itineraries."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./sign-in._-Dxcaa0wf.mjs");
const Route$2 = createFileRoute("/sign-in/$")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Access your HeritageVerse dashboard, favorites, and AI travel planner."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./place._name-Ddr-pUjV.mjs");
...
const $$splitComponentImporter = () => import("./destination._slug-CRJAdYsV.mjs");
...
const PlannerRoute = Route$a.update({
  id: "/planner",
  path: "/planner",
  getParentRoute: () => Route$d
});
const FavoritesRoute = Route$9.update({
  id: "/favorites",
  path: "/favorites",
  getParentRoute: () => Route$d
});
...
const BookingsRoute = Route$7.update({
  id: "/bookings",
  path: "/bookings",
  getParentRoute: () => Route$d
});
