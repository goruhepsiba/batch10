...
const __vite_import_meta_env__ = { "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SSR": true, "TSS_DEV_SERVER": "false", "TSS_DEV_SSR_STYLES_BASEPATH": "/", "TSS_DEV_SSR_STYLES_ENABLED": "true", "TSS_DISABLE_CSRF_MIDDLEWARE_WARNING": "false", "TSS_INLINE_CSS_ENABLED": "false", "TSS_ROUTER_BASEPATH": "", "TSS_SERVER_FN_BASE": "/_serverFn/", "VITE_CLERK_PUBLISHABLE_KEY": "pk_test_ZGVjaWRpbmctY2FtZWwtNS5jbGVyay5hY2NvdW50cy5kZXYk", "VITE_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL": "/", "VITE_CLERK_SIGN_IN_URL": "/sign-in", "VITE_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL": "/", "VITE_CLERK_SIGN_UP_URL": "/sign-up", "VITE_SUPABASE_PUBLISHABLE_KEY": "sb_publishable_wvcDKPb8AeJVZD3p_qfB_Q_-Wjfxnyv", "VITE_SUPABASE_URL": "https://xqtkdgqawytnzezwtjyx.supabase.co" };
...
export {
  ...
  match as D,
  logger as E,
  getAutoProxyUrlFromEnvironment as F,
  isLegacyDevAccountPortalOrigin as G,
  isCurrentDevAccountPortalOrigin as H,
  buildAccountsBaseUrl as I,
  parsePublishableKey as J,
  getSuffixedCookieName as K,
  retry as L,
  isClerkAPIResponseError as M,
  parseError as N,
  useUser as O,
  isTruthy as P,
  isDevelopmentEnvironment as Q,
  isAutomatedEnvironment as R,
  handleNetlifyCacheInDevInstance as S,
  TelemetryCollector as T,
  apiUrlFromPublishableKey as U,
  isProxyUrlRelative as V,
  isHttpOrHttps as W,
  resolveKeysWithKeylessFallback as X,
  createKeylessService as Y,
  createNodeFileStorage as Z,
  __experimental_JWTPayloadToAuthObjectProperties as _,
  useClerkInstanceContext as a,
  buildErrorThrower as b,
  useInitialStateContext as c,
  deriveState as d,
  eventMethodCalled as e,
  createCheckAuthorization as f,
  isDeeplyEqual as g,
  usePortalRoot as h,
  inBrowser as i,
  getEnvVariable as j,
  ...
  handleValueOrFn as o,
  createClerkEventBus as p,
  clerkEvents as q,
