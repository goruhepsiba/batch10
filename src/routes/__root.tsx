  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display text-5xl mt-2">Lost on the trail</h1>
        <p className="mt-3 text-muted-foreground">
          That destination isn't on our map yet. Head back home to keep exploring.
        </p>
        <Link
          to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "HeritageVerse — Discover the world's heritage" },
      {
        name: "description",
        content:
          "Explore cultural and historical destinations worldwide with rich guides, 360° views, weather, hotels and AI trip planning.",
      },
