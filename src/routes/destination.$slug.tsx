  ...
  notFoundComponent: () => (
    <div className="container-prose py-24 text-center">
      ...
      <Link
        to="/search"
        search={{ q: "" }}
        className="mt-6 inline-block text-amber underline underline-offset-4"
      >
        Browse destinations
      </Link>
    </div>
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="container-prose pt-24 pb-20 md:pt-32 md:pb-28 text-parchment">
            ...
            {d.unesco && (
              <>
                ...
                <span className="inline-flex items-center gap-1">
                  <Award className="h-3 w-3" /> UNESCO Site
                </span>
              </>
            )}
            {d.built && (
              <>
                <span>•</span>
                <span>Built {d.built}</span>
              </>
            )}
          </div>
          <h1 className="mt-4 font-display text-5xl md:text-7xl leading-[1.02] text-parchment font-bold drop-shadow-[0_2px_24px_rgba(0,0,0,0.55)]">
            {d.name}
          </h1>
          ...
          <p className="mt-6 max-w-2xl text-lg text-parchment/85 font-light leading-relaxed">
            {d.short}
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <button
              onClick={() => {
                if (
                  confirm(`Want to plan a trip to ${d.name}? Our AI will draft an itinerary now.`)
                ) {
                  navigate({
                    to: "/planner",
      ...
      <section className="container-prose mt-16 grid lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-14">
          <article>
            ...
            <p className="mt-4 leading-relaxed text-foreground/90 font-light text-sm md:text-base">
              {d.about}
            </p>
            ...
            <article className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="rounded-2xl glass-card p-5 space-y-3 shadow-soft">
                  ...
                  <ul className="text-xs space-y-2 text-foreground/90 font-light list-disc pl-3">
                    {aiInfo.photographyTips.map((p, i) => (
                      <li key={i}>{p}</li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 text-xs">
              ...
              <div className="rounded-xl bg-background/60 border border-border/60 p-3">
                ...
                <p className="mt-1 font-semibold flex items-center gap-1">
                  <Globe2 className="h-3.5 w-3.5" /> {d.country}
                </p>
              </div>
            </div>
      ...
      {nearby.length > 0 && (
        <section className="container-prose mt-24">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {nearby.map((n) => (
              <DestinationCard key={n.slug} d={n} />
            ))}
          </div>
        </section>
      )}
