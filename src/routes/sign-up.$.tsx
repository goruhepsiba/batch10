...
export const Route = createFileRoute("/sign-up/$")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create an account to save historical sites and generate AI itineraries." },
    ],
  }),
    ...
    <div className="flex min-h-[85vh] items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] relative z-10">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">Begin your journey today</p>
        </div>
